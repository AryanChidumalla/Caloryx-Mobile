...
export default function CreateRoutineScreen() {
  ...
  const { createRoutine, selectedRoutineExercise, setSelectedRoutineExercise } =
    useWorkout();
  ...
  useEffect(() => {
    ...
    handleAddExercise(selectedRoutineExercise);
        ...
        <View style={styles.exercisesSection}>
          <View style={styles.exercisesHeader}>
            ...
            <TouchableOpacity
              ...
              onPress={() => router.push("/workout/routines/exercises")}
            >
